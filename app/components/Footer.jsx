...
export default function Footer() {
  return (
    <div className="mb-2 flex w-full select-none items-center justify-between border-t-4 border-neutral-900 px-1 pt-3 sm:mb-4">
      <p className="select-none text-xs text-neutral-400">
        {new Date().getFullYear()} ©{" "}
        <Link
          href="https://omar11.sa/"
          target="_blank"
          className="font-bold text-neutral-500 underline-offset-2 hover:underline"
        >
          Omar Abdulaziz
        </Link>
      </p>
